 ...
 return (
    <div className="w-screen min-h-screen flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat overflow-hidden" style={{ backgroundImage: "url('/bg-cinda.png')" }}>
      ...
      <div className="w-full max-w-5xl relative rounded-3xl shadow-xl p-6 border border-yellow-300 overflow-hidden bg-yellow-50">
        ...
        {/* LOGO */}
       <div className="absolute top-4 left-4 flex items-center gap-2 bg-amber-200 border-2 border-amber-400 px-3 py-2 rounded-xl shadow-md z-10">
  ...
  return (
    <div className="relative rounded-2xl p-5 flex flex-col items-center border-2 border-yellow-200/60 bg-yellow-50/50 backdrop-blur-md shadow-lg">
      ...
      <input
          ...
          className="text-center text-xl font-bold bg-amber-400 text-black rounded-xl px-3 py-2 w-full outline-none"
        />
